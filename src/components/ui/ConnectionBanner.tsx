  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        className={`shrink-0 overflow-hidden ${isOffline ? 'bg-[rgba(239,68,68,0.08)] border-b border-[rgba(239,68,68,0.2)]' : 'bg-[rgba(245,158,11,0.08)] border-b border-[rgba(245,158,11,0.2)]'}`}
      >
        <div className="flex items-center gap-3 px-4 py-2">
          ...
          <p className={`text-xs flex-1 ${isOffline ? 'text-[var(--color-nexus-red)]' : 'text-[var(--color-nexus-amber)]'}`}>
            {isOffline
